...
// MVP v1 prototype
// See https://github.com/nhsuk/register-with-a-gp-design/blob/master/Register%20interaction%20flow/register-flow-v1.2.1.pdf
...
router.get('/previous-name', function(req, res) {
  res.render('mvp_v1/previous-name');
});
...
router.post('/previous-name', function(req, res) {
  ...
  if (passed === false) {
    res.render('mvp_v1/previous-name', { error });
  } else {
...
router.get('/previous-name-details', function(req, res) {
  res.render('mvp_v1/previous-name-details');
});
...
router.post('/previous-name-details', function(req, res) {
  ...
  if (passed === false) {
    res.render('mvp_v1/previous-name-details', { error });
  } else {
    if (req.session.edit === true) {
      res.redirect('confirm-details')
    } else {
...
router.get('/date-of-birth', function (req, res) {
  res.render('mvp_v1/date-of-birth');
});
...
router.post('/date-of-birth', function (req, res) {
  ...
  if (req.body['dob-day'] === '' || req.body['dob-month'] === '' || req.body['dob-year'] === '') {
    res.render('mvp_v1/date-of-birth', { error: 'Please enter your date of birth' });
  } else {
    if (req.session.edit === true) {
      res.redirect('confirm-details')
    } else {
...
router.post('/nhs-number', function (req, res) {
  ...
  if (passed === false) {
    res.render('mvp_v1/nhs-number', { error });
  } else {
...
router.get('/nhs-number-details', function (req, res) {
  res.render('mvp_v1/nhs-number-details' );
})
...
router.post('/nhs-number-details', function (req, res) {
  ...
  if (passed === false) {
    res.render('mvp_v1/nhs-number-details', { error });
  } else {
    if (req.session.edit === true) {
      res.redirect('confirm-details')
    } else {
...
router.get('/contact-details', function (req, res) {
  res.render('mvp_v1/contact-details');
});
...
router.get('/home-address', function (req, res) {
  res.render('mvp_v1/home-address-postcode');
});
        ...
        if (response.statusCode == 200) {
          ...
          if (req.session.homeAddress.building !== '') {
            ...
            if (filtered.length === 0) {
              ...
              res.render('mvp_v1/home-address-result', {
...
router.get('/select-address', function (req, res) {
  res.render('mvp_v1/select-address');
});
...
router.get('/home-address-manual', function (req, res) {
  res.render('mvp_v1/home-address-manual');
});
...
router.get('/armed-forces', function (req, res) {
  res.render('mvp_v1/armed-forces');
});
...
router.post('/armed-forces', function (req, res) {
  ...
  if (passed === false) {
    res.render('mvp_v1/armed-forces', { error });
  } else {
...
router.get('/armed-forces-service-number', function (req, res) {
  res.render('mvp_v1/armed-forces-service-number');
});
...
router.post('/armed-forces-service-number', function (req, res) {
  ...
  if (passed === false) {
    res.render('mvp_v1/armed-forces-service-number', { error });
  } else {
...
router.get('/armed-forces-enlistment-date', function (req, res) {
  res.render('mvp_v1/armed-forces-enlistment-date');
});
...
router.post('/armed-forces-enlistment-date', function (req, res) {
  ...
  if (passed === false) {
    res.render('mvp_v1/armed-forces-enlistment-date', { error });
  } else {
    if (req.session.edit === true) {
      res.redirect('confirm-details')
    } else {
...
router.get('/previous-address', function (req, res) {
  res.render('mvp_v1/previous-address');
})
...
router.post('/previous-address', function (req, res) {
  ...
  if (passed === false) {
    res.render('mvp_v1/previous-address', { error });
...
router.get('/previous-address-postcode', function (req, res) {
  res.render('mvp_v1/previous-address-postcode');
});
        ...
        if (response.statusCode == 200) {
          ...
          if (req.session.prevpostcode !== '') {
            ...
            if (filtered.length === 0) {
              ...
              res.render('mvp_v1/previous-address-result', {
...
router.get('/select-previous-address', function (req, res) {
  res.render('mvp_v1/select-previous-address');
});
...
router.get('/previous-address-manual', function (req, res) {
  res.render('mvp_v1/previous-address-manual');
});
...
router.post('/current-gp', function (req, res) {
  ...
  if (passed === false) {
    res.render('mvp_v1/current-gp', { error });
...
router.get('/current-medication', function (req, res) {
  res.render('mvp_v1/current-medication');
});
...
router.post('/current-medication', function (req, res) {
  ...
  if (passed === false) {
    res.render('mvp_v1/current-medication', { error });
...
router.get('/current-medication-details', function (req, res) {
  res.render('mvp_v1/current-medication-details');
});
...
router.post('/current-medication-details', function (req, res) {
  ...
  if (passed === false) {
    res.render('mvp_v1/current-medication-details', { error });
  } else {
    if (req.session.edit === true) {
      res.redirect('confirm-details')
    } else {
...
router.get('/confirm-details', function (req, res) {
  ...
  res.render('mvp_v1/confirm-details');
});
