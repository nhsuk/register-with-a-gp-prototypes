...
var Application = React.createClass({displayName: "Application",
  ...
  resultsList: function() {
    if (this.state.results) {
      return (
        React.createElement(ResultsList, {practices: this.state.results, 
                     pageSize: 20, 
...
var SearchForm = React.createClass({displayName: "SearchForm",
  render: function() {
    ...
    return (
      React.createElement("form", {name: "gp-search", id: "gp-search", method: "get", className: "gp-finder-search"}, 
        React.createElement("div", {className: "block-container"}, 
          ...
          React.createElement("div", {className: "clearfix"}, 
            ...
            React.createElement("button", {type: "submit", className: "button"}, "Search")
          )
        )
      )
    );
...
var ResultsList = React.createClass({displayName: "ResultsList",
  render: function() {
    return (
      React.createElement("div", {className: "block-container"}, 
        React.createElement("form", {name: "gp-results", id: "gp-results", method: "post"}, 
          this.results(), 
          this.footer()
        )
      )
  ...
  results: function() {
    if (this.props.practices.length > 0) {
      ...
      return (
        React.createElement("div", {className: "gp-finder-results", "aria-live": "polite"}, 
          results
        )
      );
    }
  ...
  footer: function() {
    return (
      React.createElement(ResultsFooter, {numberOfResults: this.props.practices.length, 
...
var PracticeResult = React.createClass({displayName: "PracticeResult",
  render: function() {
    var practitioners = this.props.practice.practitioners.map(function(practitioner, index) {
          ...
          return (
            React.createElement("p", {className: "person", key: key}, 
    ...
    if (this.props.practice.score.distance) {
      var distance = (
        React.createElement("p", {className: "distance"}, this.props.practice.score.distance, " miles away")
      );
    }

    return (
      React.createElement("a", {href: href, className: className, id: id}, 
...
var ResultsFooter = React.createClass({displayName: "ResultsFooter",
  render: function() {
...
var EndOfPage = React.createClass({displayName: "EndOfPage",
  render: function() {
    return (
      React.createElement("div", {className: "gp-finder-foot"}, 
        React.createElement("p", null, 
          React.createElement("a", {href: this.props.loadMoreHref, onClick: this.onClick}, "Show more GP practices.")
        ), 
        React.createElement("p", null, 
          "Or try searching again. You can search using:"
        ), 
        React.createElement("ul", null, 
          React.createElement("li", null, "practice name"), 
          React.createElement("li", null, "practice address"), 
          React.createElement("li", null, "postcode"), 
          React.createElement("li", null, "doctor’s name")
        ), 
        React.createElement("p", null, 
          React.createElement("a", {href: "#search"}, "Search again")
        )
      )
    );
  },
...
var EndOfResults = React.createClass({displayName: "EndOfResults",
  render: function() {
    return (
      React.createElement("div", {className: "gp-finder-foot"}, 
        React.createElement("p", null, 
...
var NoResults = React.createClass({displayName: "NoResults",
  render: function() {
    return (
      React.createElement("div", {className: "gp-finder-no-results"}, 
        React.createElement("p", null, 
          "Sorry, no practices have been found. ", React.createElement("a", {href: "#search"}, "Try searching again.")
        ), 
        React.createElement("p", null, 
          "You can search using:"
        ), 
